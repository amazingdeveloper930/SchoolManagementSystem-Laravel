...
@section('title','Costo de Servicios')
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
				...
				<tbody>
					<tr v-for="dato in datos" :key="dato.id">
                        ...
                        <td>
                        	<span v-if="dato.state==1" v-text="'Activo'">
                        	</span>
                        	<span v-if="dato.state==2" v-text="'Obligatorio'">
                        	</span>
                        	<span v-if="dato.state==3" v-text="'Inactivo'">
                        	</span>
                        </td>
                        <td>
                            @can('costs.store_edit')
						...
						<form class="m-form m-form--fit m-form--label-align-right">
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-9"><input type="text" v-model="description" class="form-control m-input m-input--air m-input--pill" id="descripcion" aria-describedby="emailHelp" placeholder="Ingrese la descripcion"></div>
								</div>
								...
								<div class="form-group m-form__group row">
									<div class="col-3"><label for="estado">Estado</label></div>
                                    <div class="col-9">
                                        <select v-model="state" class="form-control m-input m-input--air m-input--pill" id="estado">
		  ...
		  methods: {
		  	...
		  	cambiarPagina(page)
            {
		  	...
		  	checkForm(){
                ...
                if (!this.description) this.errors.push("Descripción Requerida");
                
                //Precio requerido
                if (!this.cost) this.errors.push("Precio Requerido");
                else if(!this.validateNumber(this.cost)) this.errors.push('El costo debe ser un valor numerico');

                //Estado requerido
                if (!this.state) this.errors.push("Estado Requerido");
            ...
            {
                let me = this
                var url = '/costos/services/getData?page=' + page + '&criterio=' + this.criterio + '&mostrar=' + this.mostrar + '&buscar=' + this.search

                axios.get(url)
                  .then(function (response) {
                    var respuesta = response.data;
                    me.datos = respuesta.services.data;
            ...
            registre(){
                ...
                axios.post('/costos/services/store',{
            ...
            edit(id){
            	...
            	axios
            	.get('/costos/services/edit/' + id)
            	.then(function(response){
            		var respuesta = response.data;
            		objeto = respuesta.service;
            		console.log(objeto);
            ...
            destroy(id){
            	...
            	axios
            	.delete('/costos/services/delete/' + id)
            	.then(function(response){
            		var respuesta = response.data;
                    me.getData(1);
            ...
            openModal(action, data = [])
            {
            	...
            	if (action == 1) {
                    this.action = 1;
                    this.titleModal = "Registrar Servicio"
                }else if (action == 2) {
                    this.action = 2
